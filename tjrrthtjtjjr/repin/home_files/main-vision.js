/*
Theme Name: RePIN MASTERBATCHES v1
Theme URI: http://repin.in
Description: Better than all the rest
Version: 1.0
Author: Suitcase26
Author URI: http://suitcase26.com
*/
...
var slides = 4;
var run = 0;
var speed = [10000, 5000, 5000, 5000];
var workSlide = true;
...
function modoTeatro(val){
	...
	if(val == true){
		...
		$('#moduleSLIDER').animate({'height': 350}, 450, 'easeInOutExpo');
		where = "#moduleTOP";
	}
    scrollWhere(where);
}
...
jQuery(document).ready(function($) {
	...
	function setSlider(goto){
		...
		$(imageIn).animate({'top': 0}, 1800, 'easeInOutExpo');
		
		//Sacamos el slide anterior
		$(imageOut).animate({'top': top_value}, 1320, 'easeInOutExpo');
